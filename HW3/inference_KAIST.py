...
# model_def = '/opt/caffe/models/bvlc_reference_caffenet/deploy_bn.prototxt'
# model_weights = '/opt/caffe/models/bvlc_reference_caffenet/200520_model/200520_model_bn_iter_170000.caffemodel'
model_def = 'prototxt/deploy_bn.prototxt'
model_weights = 'model/200520_model_bn_iter_170000.caffemodel'


# Path for mean
# mu = np.load('/workspace/KAIST_Test/test_data_mean.npy')
mu = np.load('KAIST_Test/test_data_mean.npy')

# Path for label, dataset
# labels_file = '/workspace/GTSRB_Test/Final_Test/test.txt'
# dataset_path = '/workspace/GTSRB_Test/Final_Test'
...
plt.savefig("200521_KAIST_accuracy.png")
#plt.show()
